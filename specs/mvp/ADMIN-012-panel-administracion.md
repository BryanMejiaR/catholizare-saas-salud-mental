...
---
Reglas de negocio
El Administrador y el Super Administrador no tienen acceso al contenido clínico de los expedientes.
Se considera contenido clínico: notas, diagnósticos, hipótesis, formulación, texto libre de motivo de consulta, resultados de pruebas, imágenes de evaluaciones, narrativas, evolución y observaciones clínicas.
El Administrador puede ver estados administrativos mínimos.
Toda consulta de logs queda registrada.
No existe eliminación física de datos desde el panel administrativo; las operaciones ordinarias son lógicas.
El Super Administrador es el único rol ordinario que puede crear cuentas de Administrador.
La creación de Super Administradores queda restringida a cuenta raíz o propietario autorizado.
El panel de administración es una interfaz separada del panel Profesional y portal del Paciente.
Los servicios de IA no podrán recibir datos de identificación directa ni contenido clínico identificable salvo caso explícito autorizado conforme a privacidad.
Toda acción administrativa sensible debe registrarse en auditoría.
El sistema debe operar bajo principio de mínimo privilegio.
Las estadísticas clínicas agregadas solo podrán mostrarse si cumplen anonimización, agregación y umbral mínimo.
Administradores y Super Administradores no tienen acceso al contenido clínico de evaluaciones psicológicas, imágenes de pruebas, inventarios, protocolos ni interpretaciones psicométricas individuales.
---
Datos que maneja
